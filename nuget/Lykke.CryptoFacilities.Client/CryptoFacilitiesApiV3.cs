...
using Lykke.CryptoFacilities.Exceptions;
using Lykke.CryptoFacilities.Models.Common;
using Lykke.CryptoFacilities.Models.Request;
using Lykke.CryptoFacilities.Models.Request.BatchOrder;
...
{
    public class CryptoFacilitiesApiV3 : ICryptoFacilitiesApiV3
    {
        ...
        public CryptoFacilitiesApiV3(string apiPath, string apiPublicKey, string apiPrivateKey, bool checkCertificate, ILogFactory logFactory)
        {
            _apiPath = apiPath;
        ...
        private static void CheckForError(BaseResponse data)
        {
            ...
            switch (data.Error)
            {
                ...
                default: throw new CryptoFacilitiesException($"Unknown error: {data.Error}");
            }
        }
