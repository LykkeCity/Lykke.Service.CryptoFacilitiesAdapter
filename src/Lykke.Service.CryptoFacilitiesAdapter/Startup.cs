...
using Lykke.Service.CryptoFacilitiesAdapter.Settings;
...
namespace Lykke.Service.CryptoFacilitiesAdapter
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "CryptoFacilitiesAdapter API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "CryptoFacilitiesAdapterLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.CryptoFacilitiesAdapterService.Db.LogsConnectionString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("CryptoFacilitiesAdapter", channelOptions =>
                        {
