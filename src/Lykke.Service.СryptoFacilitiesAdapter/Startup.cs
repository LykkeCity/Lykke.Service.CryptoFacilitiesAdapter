...
namespace Lykke.Service.СryptoFacilitiesAdapter
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "СryptoFacilitiesAdapter API",
            ApiVersion = "v1"
        };
            ...
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("СryptoFacilitiesAdapter", channelOptions =>
                        {
